...
while running:
        ...
        if event.type == pygame.QUIT:
            ...
            if current_screen == "menu":
                if event.key == pygame.K_DOWN:
                    ...
                    save_high_score()
                    load_high_score()
                    reset_text = subtitle_font.render(f"Highscore Reiniciado!", True, YELLOW)
            ...
            # jugabilidad - disparos modificados para multijugador
    ...
    # pantalla de juego principal donde ocurre la accion
    elif current_screen == "play":
        ...
        # mover y dibujar enemigos en la pantaya
        enemy_moved = False
        for enemy in enemies[:]:
